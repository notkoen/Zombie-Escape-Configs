...
{
	s1 = "Defend for "
	s2 = " seconds until the boards break"
	CountdownTimer(25);
}
...
function Msg6()
{
	s1 = "Defend until the obstacles clear in "
	s2 = " seconds"
	CountdownTimer(40);
}
...
function Msg22()
{
	...
	s2 = " seconds \nMetal door will open afterwards!"
	CountdownTimer(20);
}
...
{
	s1 = "Defend for "
	s2 = " until metal door opens \nZombies are held back temporarily"
	CountdownTimer(15);
}
